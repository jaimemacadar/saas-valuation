...
Analyze all frontend aplication and extract design tokens, and set up a complete design system with shadcn/ui.

## Workflow

### 1. Analyze the Design

Look at all frontend aplication and identify/infer:
...
- Update documentation whith documentation-writer agent of mcp ai-context
